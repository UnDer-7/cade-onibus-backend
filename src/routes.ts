...
routes.post(`${sessionURLs}/recovery`, SessionController.forgotPasswordPassword);
routes.post(`${sessionURLs}/forgot-password-valid`, SessionController.isForgotPasswordTokenValid);
